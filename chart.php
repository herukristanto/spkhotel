...
$nama = $mysqli->query($sql);
$nilai = $mysqli->query($sql);
	


    ?>
                    labels: [<?php  while ($a = mysqli_fetch_array($nama)) {echo '"'.$a['nama'].'",';}?>],
                    datasets: [{
							
                            label: '# of Votes',
                            data: [<?php  while ($b = mysqli_fetch_array($nilai)) {echo $b['nilai']. ', '; } ?>],
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.2)',
                                'rgba(54, 162, 235, 0.2)',
                                'rgba(255, 206, 86, 0.2)',
